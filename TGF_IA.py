...
def subscribe(client: mqtt_client):
    def on_message(client, userdata, msg): 
        ...
        if msg.topic == "TGF" and msg.payload.decode()=="G08":
            ...
            if msg.payload.decode()=="G03":
            ...
            elif sliced_data and msg.payload.decode()!="G07" and msg.payload.decode()[0] =='G' and "G98" not in sliced_data.previousMoves and  "G99" not in sliced_data.previousMoves:
                ...
                if payload =="G24":
                   ...
                   print("Abandon de l'adversaire")
                    ...
                    if sliced_data.leftBoats:
                        publish(client,TSP.pub,"G44")
                        for boats in sliced_data.leftBoats:
                            for boat in boats:
                                posBoat=str(boat[0])+str(boat[1])
                                publish(client,TSP.pub,"T"+posBoat)
                        publish(client,TSP.pub,"G45")
                    ...
                    if sliced_data.leftBoats:
                        ...
                        publish(client,TSP.pub,"G45")
                    publish(client,TSP.pub,"G06")
            elif msg.payload.decode()[0] == 'T' and "G98" not in sliced_data.previousMoves and  "G99" not in sliced_data.previousMoves:
                ...
                if not package[1].leftBoats:
                    ...
                    time.sleep(1)
                publish(client,TSP.pub,package[0])
            elif msg.payload.decode()[0] in "SMH"  and "G98" not in sliced_data.previousMoves and "G99" not in sliced_data.previousMoves: 
